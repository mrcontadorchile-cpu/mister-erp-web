...
const nav = [
  ...
  },
  {
    group: 'MOVIMIENTOS',
    items: [
      { href: '/libro-diario',       label: 'Libro Diario',  icon: BookIcon },
      { href: '/libro-diario/nuevo', label: 'Nuevo Asiento', icon: PlusSquareIcon },
      { href: '/libro-mayor',        label: 'Libro Mayor',   icon: LedgerIcon },
    ],
  },
  {
  ...
  },
  {
    group: 'CONFIGURACIÓN',
    items: [
      { href: '/configuracion', label: 'Empresa', icon: SettingsIcon },
    ],
  },
]
